...
map.insert("password".to_string(), "Lazy0760".to_string());
RwLock::new(map)
};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.570011.xyz"];
pub const RS_PUB_KEY: &str = "m+2pFpe1b833wPwBwpHV6LZUgcRXvBPBmBr2A510R4c=";
